...
public class NotificationSubject {
    //for patient
    public static final String PATIENT_APPOINTMENT_CONFIRMED="appointment.patient.confirmed";
    public static final String PATIENT_APPOINTMENT_REJECTED="appointment.patient.rejected";
